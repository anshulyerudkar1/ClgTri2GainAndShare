	...
	<div class="panel-pop" id="lost-password">
		...
		<div class="form-style form-style-3">
			...
			<form >
				...
				<p class="form-submit">
					<input type="submit" value="Forgot" name="update" class="button color small submit" >
				</p>
			</form>
	...
	<header id="header" >
		<section class="container clearfix">
			...
			<nav class="navigation">
				<ul>
					<li class="current_page_item"><a href="uhome.php">Home</a>
						
					</li>
					<li class="ask_question" id="top"><a href="askquestion.php">Ask Question</a></li>
					<li><a href="#">Questions</a>
						<ul>
							<li><a href="acategory.php">Questions Category</a></li>
